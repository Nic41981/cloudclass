...
public class ChapterExamInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (!permissionService.isChapterExamExist(examId)){
            try {
        ...
        String courseId = permissionService.getCourseIdByChapterExam(examId);
        if (courseId == null){
            try {
